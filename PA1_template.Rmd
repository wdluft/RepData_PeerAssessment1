...
```{r steps_per_day_hist, fig.height = 4.5, fig.width = 6}
...
```{r interval_averages_plot, fig.height = 4.5, fig.width = 6}
...
```
The total number of rows with missing values is `r rows_with_na`.
...
```{r imputed_data_hist, fig.height = 4.5, fig.width = 6}
...
but not in a signifacnt way. The median becomes one of the substituted values.
...
```{r weekday_vs_weekend_plot, fig.height = 4.5, fig.width = 6}
